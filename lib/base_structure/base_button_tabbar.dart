...
class _TabBarScrollPosition extends ScrollPositionWithSingleContext {
  ...
  final _BaseButtonTabBarState tabBar;
...
/// A Design widget that displays a horizontal row of tabs.
class BaseButtonTabBar extends StatefulWidget
  ...
  /// and the entire [BaseButtonTabBar] is scrollable. Otherwise each tab gets an equal
  ...
  @override
  State<BaseButtonTabBar> createState() =>
      _BaseButtonTabBarState();
}

class _BaseButtonTabBarState extends State<BaseButtonTabBar>
  ...
  @override
  void didUpdateWidget(BaseButtonTabBar oldWidget) {
