...
class LightModeTheme extends BaseTheme {
  @Deprecated('Use primary instead')
  Color get primaryColor => primary;
  @Deprecated('Use secondary instead')
  Color get secondaryColor => secondary;
  ...
  late Color primary = const Color(0xFF113946);
  late Color secondary = const Color(0xFF161515);
  late Color tertiary = const Color(0xFFD0CDC8);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFB000000);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFF113946);
  late Color accent2 = const Color(0xFFFFFFFF);
  late Color accent3 = const Color(0xFFF0F5FA);
  late Color accent4 = const Color(0xCCFFFFFF);
  late Color success = const Color(0xFF00C308);
...
class ThemeTypography extends Typography {
  ...
  String get labelLargeFamily => 'Playfair Display';
  ...
  String get labelMediumFamily => 'Playfair Display';
  ...
  String get labelSmallFamily => 'Playfair Display';
  ...
  String get bodyLargeFamily => 'Playfair Display';
