...
import 'save_changes_alert_model.dart';
export 'save_changes_alert_model.dart';

class SaveChangesAlertWidget extends StatefulWidget {
  const SaveChangesAlertWidget({super.key});

  @override
  State<SaveChangesAlertWidget> createState() => _SaveChangesAlertWidgetState();
}

class _SaveChangesAlertWidgetState extends State<SaveChangesAlertWidget> {
  late SaveChangesAlertModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SaveChangesAlertModel());
  }
