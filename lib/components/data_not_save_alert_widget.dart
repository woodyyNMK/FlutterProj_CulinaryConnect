...
import 'data_not_save_alert_model.dart';
export 'data_not_save_alert_model.dart';

class DataNotSaveAlertWidget extends StatefulWidget {
  const DataNotSaveAlertWidget({super.key});

  @override
  State<DataNotSaveAlertWidget> createState() => _DataNotSaveAlertWidgetState();
}

class _DataNotSaveAlertWidgetState extends State<DataNotSaveAlertWidget> {
  late DataNotSaveAlertModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DataNotSaveAlertModel());
  }
