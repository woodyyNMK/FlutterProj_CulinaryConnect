...
import 'data_clear_alert_model.dart';
export 'data_clear_alert_model.dart';

class DataClearAlertWidget extends StatefulWidget {
  const DataClearAlertWidget({super.key});

  @override
  State<DataClearAlertWidget> createState() => _DataClearAlertWidgetState();
}

class _DataClearAlertWidgetState extends State<DataClearAlertWidget> {
  late DataClearAlertModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DataClearAlertModel());
  }
