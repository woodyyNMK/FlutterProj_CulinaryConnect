...
import 'profile_recipe_page_model.dart';
export 'profile_recipe_page_model.dart';

class ProfileRecipePageWidget extends StatefulWidget {
  const ProfileRecipePageWidget({super.key});

  @override
  State<ProfileRecipePageWidget> createState() =>
      _ProfileRecipePageWidgetState();
}

class _ProfileRecipePageWidgetState extends State<ProfileRecipePageWidget> {
  late ProfileRecipePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfileRecipePageModel());
  }
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<RecipeRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<RecipeRecord> profileRecipePageRecipeRecordList = snapshot.data!;
                                  ...
                                  children: [
                                    Text(
                                      valueOrDefault<String>(
                                        profileRecipePageRecipeRecordList.length
                                            .toString(),
                                        '0',
                                      ),
                                      style: BaseTheme.of(context)
